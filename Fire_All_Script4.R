...
rm(list = ls())
load("G:\\Faculty\\Mann\\Other\\Fire\\StackOutputs\\firedata_allfire3i.RData")
...
#                                        "G:\\Faculty\\Mann\\Other\\Fire\\Uden10x10_2650_proj.tif",
  ...
  # location of all files not explicitly referenced above
  ...
  #directories_inputs = c("P:\\Meg's computer (Scheherazade)\\meg\\cec_vulnerability & adaptation\\data analysis\\digested data1080",
  #                       "P:\\Meg's computer (Scheherazade)\\meg\\cec_vulnerability & adaptation\\data analysis\\digested data1080 future")
...
# Compare westerling counts and FRAP
# 
# west=read.csv('G:\\Faculty\\Mann\\Share\\Fire\\Fire Counts Westerling\\ALL.COUNT.8004.txt')
# frap= data1976_2000$fire_poly 
# pts = data1976_2000[,c('x','y')]  # points that match  
# frap <-  rasterize(pts,alldata1976_2000[[1]],frap,fun=sum)
# windows()
# plot(frap)
# 
# windows()
# plot(raster(alldata1976_2000,'Ppall'))
# 
# writeRaster(raster(alldata1976_2000,'Ppall'),'G://Faculty//Mann//Share//Fire//Fire_All_Script_Outputs//ppall.tif')
# 
...
names(data1976_2000)
  ...
  [1] "X"               "X.2"             "X.1"             "aetAave"        
  [5] "aetAsd"          "cwdAave"         "cwdAmm"          "cwdAmp"         
  [9] "cwdApm"          "cwdAsd"          "petAave"         "petAsd"         
 [13] "pptAave"         "pptAmm"          "pptAmp"          "pptApm"         
 [17] "pptAsd"          "tmnAave"         "tmnAsd"          "tmxAave"        
 [21] "tmxAsd"          "den"             "den3x3"          "den5x5"         
 [25] "den10x10"        "den20x20"        "denmax5x5"       "denmax10x10"    
 [29] "denmax20x20"     "denmax50x50"     "elev"            "FVeg"           
 [33] "Jepson"          "Slope"           "NorthSoutha"     "OceanDistEuc"   
 [37] "AllRoads"        "Incorp"          "PrimSec"         "Pp30k"          
 [41] "Pp20k"           "Ppall"           "Water"           "stationdist"    
 [45] "campdist"        "airdist"         "allstationdist"  "ExcldLand"      
 [49] "NPark"           "PubLand"         "PubLandDum"      "LightPredC2"    
 [53] "LightPredD"      "LightMarc"       "Light5yrWIS"     "aetAave2"       
 [57] "aetAsd2"         "cwdAave2"        "cwdAmm2"         "cwdAmp2"        
 [61] "cwdApm2"         "cwdAsd2"         "petAave2"        "petAsd2"        
 [65] "pptAave2"        "pptAmm2"         "pptAmp2"         "pptApm2"        
 [69] "pptAsd2"         "tmnAave2"        "tmnAsd2"         "tmxAave2"       
 [73] "tmxAsd2"         "den2"            "den3x32"         "den5x52"        
 [77] "den10x102"       "den20x202"       "denmax5x52"      "denmax10x102"   
 [81] "denmax20x202"    "denmax50x502"    "elev2"           "FVeg2"          
 [85] "Jepson2"         "Slope2"          "NorthSoutha2"    "OceanDistEuc2"  
 [89] "AllRoads2"       "Incorp2"         "PrimSec2"        "Pp30k2"         
 [93] "Pp20k2"          "Ppall2"          "Water2"          "stationdist2"   
 [97] "campdist2"       "airdist2"        "allstationdist2" "ExcldLand2"     
[101] "NPark2"          "PubLand2"        "PubLandDum2"     "LightPredC22"   
[105] "LightPredD2"     "LightMarc2"      "Light5yrWIS2"    "x"              
[109] "y"               "fire_poly"       "group2"          "train"          
[113] "test"          
